...
function launcher_assets() {
    ...
    if (is_page()) {
        ...
        if ($launcher_template_name == "launcher.php") {
            ...
            wp_enqueue_script("bootstrap-jquery-js", get_theme_file_uri("/assets/js/bootstrap.min.jss"), array("jquery"), null, true);
...
function launcher_sidebars() {
    ...
    register_sidebar( array(
        ...
        'class'         => '',
        'before_widget' => '<section id="%1" class="text-right widget %2">',
        'after_widget'  => '</section>',
        'before_title'  => '<h2 class="widget-title">',
        'after_title'   => '</h2>',
    ));
